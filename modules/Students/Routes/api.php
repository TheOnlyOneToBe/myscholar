...
Route::prefix('api')->middleware(['api', 'auth'])->group(function () {
    ...
    Route::prefix('students/id-format')->group(function () {
        ...
        Route::put('', [StudentIdFormatController::class, 'update'])->name('students.id-format.update');
    ...
    Route::prefix('students')->group(function () {
        ...
        // Student Actions
        Route::post('{student}/suspend', [StudentController::class, 'suspend'])->name('students.suspend');
        Route::post('{student}/activate', [StudentController::class, 'activate'])->name('students.activate');
    ...
    Route::prefix('enrollments')->group(function () {
        ...
        Route::get('statistics', [EnrollmentController::class, 'statistics'])->name('enrollments.statistics');
        ...
        // Enrollment Actions
        Route::post('{enrollment}/suspend', [EnrollmentController::class, 'suspend'])->name('enrollments.suspend');
        Route::post('{enrollment}/resume', [EnrollmentController::class, 'resume'])->name('enrollments.resume');
    });
});
