...
class AcademicCalendarService
{
    ...
    {
        if (!Schema::hasTable('class_events')) {
            return [];
        }
        ...
        try {
            ...
            \Log::debug("Erreur lors de la récupération des événements: " . $e->getMessage());
            return [];
        }
    }
    ...
    private function getImportantDatesOptimized(): array
    {
        ...
        try {
            ...
            \Log::debug("Erreur lors de la récupération des dates importantes: " . $e->getMessage());
            return [];
        }
    }
    ...
    private function getExamsScheduleOptimized(int $studentId): array
    {
        ...
        try {
            ...
            \Log::debug("Erreur lors de la récupération des examens: " . $e->getMessage());
            return [];
        }
    }
    ...
    private function getHolidaysOptimized(): array
    {
        ...
        try {
            ...
            \Log::debug("Erreur lors de la récupération des vacances: " . $e->getMessage());
            return [];
        }
    }
