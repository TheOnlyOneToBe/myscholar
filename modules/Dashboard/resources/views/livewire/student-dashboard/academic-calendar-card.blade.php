<div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-indigo-500">
    <div class="flex items-center justify-between mb-4">
        <h3 class="text-lg font-bold text-gray-800">📅 Calendrier Académique</h3>
    ...
    @else
        ...
        <div class="mb-6">
            <h4 class="font-semibold text-gray-800 mb-3">📌 Événements à Venir</h4>
        ...
        <div class="mb-6">
            <h4 class="font-semibold text-gray-800 mb-3">📝 Horaire des Examens</h4>
            <div class="space-y-2">
                ...
                <div class="flex items-center justify-between p-3 bg-red-50 border-l-4 border-red-500 rounded {{ $exam['is_soon'] ? 'ring-2 ring-red-300' : '' }}">
                    ...
                    @if ($exam['is_soon'])
                    <span class="inline-block bg-red-500 text-white text-xs font-bold px-2 py-1 rounded">⏰ Bientôt!</span>
                    @endif
                </div>
                @endforeach
            </div>
        ...
        <div class="mb-6">
            <h4 class="font-semibold text-gray-800 mb-3">🎯 Dates Importantes</h4>
            <div class="space-y-2">
                ...
                <div class="flex items-center justify-between p-3 bg-gray-50 rounded border-l-4 {{
                    ...
                    <span class="text-xl">{{ $date['icon'] }}</span>
                </div>
                @endforeach
            </div>
        </div>
        ...
        <div>
            <h4 class="font-semibold text-gray-800 mb-3">🎉 Vacances Scolaires</h4>
            <div class="space-y-2">
